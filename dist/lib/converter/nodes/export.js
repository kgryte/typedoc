...
exports.ExportDeclarationConverter = exports.ExportConverter = void 0;
    ...
    convert(context, node) {
        ...
        if (node.exportClause) {
            node.exportClause.elements.forEach(specifier => {
                ...
                const target = context.resolveAliasedSymbol(context.getSymbolAtLocation((_a = specifier.propertyName) !== null && _a !== void 0 ? _a : specifier.name));
                if (source && target) {
